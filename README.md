# Classic Gwent from The Witcher 3: Wild Hunt
...
- Slightly refurbished UI to properly show icons
- Properly stretches on UW monitors
- Added the ability to sort cards
- Keyboard navigation: Space to pass, X to activate leader, Enter/arrows to navigate carousels, E/Q for popups
- Nilfgaard faction now shows a distinct notification when it wins a round via the draw rule
- Right-click any card in the deck builder to preview it in the carousel
- Game statistics (W/D/L and best win streak) tracked across games and shown on the end screen
- Richer faction-specific notification messages for all five factions
